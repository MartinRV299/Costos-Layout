 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_renderHeader: function() {
			...
			prevIcon.addClass('fa fa-chevron-left text-blue');
			...
			yearDiv.attr('id','yearAsesores');
			yearDiv.text(this.options.startYear);

			MetodosDiversos.obtenerAnio(this.options.startYear);
			...
			nextIcon.addClass('fa fa-chevron-right text-blue');
